...
function(a) {
    ...
    function e(a, d, e) {
        ...
        } else c(a, d.$element, d.$icon),
        e.eventType = "deselected",
        e.dataForEvent = []
    }
    var f = a.fn.tree,
    g = function(b, c) {
    ...
    g.prototype = {
        ...
        populate: function(b, c) {
            ...
            function(b) {
                ...
                function(b, c) {
                    ...
                    g ? (e.attr('nodeId', c.id),f.append(e)) : f.find(".tree-branch-children:eq(0)").append(e)
                }),
        ...
        discloseAll: function() {
            ...
            a.options.cacheItems || a.$element.one("closeAll.fu.tree",
            function() {
                ...
                a.$element.one("disclosedVisible.fu.tree",
                function() {
                    a.discloseAll()
                }),
                a.discloseVisible()
