...
import com.mingqian.core.exception.BaseException;
...
public abstract class Strings {
    ...
    */
    ...
    public static Pair<String, String> removeSubstringBetween(String str, String tag) {
        return removeSubstringBetween(str, tag, tag);
    }

    public static Pair<String, String> removeSubstringBetween(String str, String open, String close) {
        if (str == null || open == null || close == null) {
            return null;
        }
        int start = str.indexOf(open);
        if (start != -1) {
            ...
            if (end != -1) {
                ...
                int tailStart = end + close.length();
                String tailString = tailStart <= str.length() ? str.substring(tailStart) : "";
                String leftString = str.substring(0, start) + tailString;
                return Pair.makePair(leftString, subString);
            }
        }
